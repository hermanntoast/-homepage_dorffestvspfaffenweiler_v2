...
export const vereine: Verein[] = [
  {
    ...
    beschreibung: "Motto: Alm on Fire",
  ...
  },
  {
    ...
    beschreibung: "Bierwagen & Grillstand",
  ...
  },
  {
    ...
    beschreibung: "MuT + Kirchenchor",
    logo: "/logos/vereine/mut.png",
    website: "#",
    essen: ["Angebot wird noch bekannt gegeben"],
    getraenke: ["Angebot wird noch bekannt gegeben"],
  },
  {
    id: 6,
    name: "Tennisclub Pfaffenweiler",
    beschreibung: "Weinstand",
    logo: "/logos/vereine/tennis.png",
    website: "https://www.tc-1980-pfaffenweiler.de/",
    essen: ["Speisen werden noch geplant"],
    getraenke: ["Weinstand Sa & So", "Weitere Getränke geplant"],
  },
  {
    id: 7,
    name: "Landfrauen Pfaffenweiler",
    beschreibung: "Kaffee, Kuchen & mehr",
...
export const gelaendeBereiche: GelaendeBereich[] = [
  ...
  { id: "kjg", name: "KjG", beschreibung: "Alm on Fire", verein: "KjG Pfaffenweiler", x: 20, y: 20, width: 200, height: 80, farbe: "#16a34a", rotation: 4 },
  ...
  { id: "grillhuette", name: "Narrenverein", beschreibung: "Grillhütte", verein: "Narrenverein Wolfbach-Rolli", x: 320, y: 20, width: 80, height: 40, farbe: "#ea580c" },

  // Links – KiGA/Schule (6m hoch × 3m breit)
  { id: "kiga", name: "Schule/Kita", beschreibung: "Candy Bar, Eis & Schminkstation", verein: "Schule / Kita", x: 20, y: 140, width: 30, height: 60, farbe: "#a855f7" },

  // Links – FC-Stand (15m hoch × 7m breit)
  { id: "fc", name: "FC", beschreibung: "Bratwürste & Bierwagen", verein: "FC Pfaffenweiler", x: 20, y: 220, width: 70, height: 150, farbe: "#2563eb" },
  ...
  { id: "mut", name: "MuT", beschreibung: "Musik- & Trachtenkapelle + Kirchenchor", verein: "Musik- & Trachtenkapelle + Kirchenchor", x: 340, y: 80, width: 60, height: 100, farbe: "#16a34a" },

  // Rechts – Tennis (7m hoch × 3m breit)
  { id: "tennis", name: "Tennis", beschreibung: "Weinstand", verein: "Tennisclub Pfaffenweiler", x: 350, y: 200, width: 70, height: 45, farbe: "#0891b2" },

  // Rechts – Landfrauen (18m hoch × 5m breit)
  { id: "landfrauen", name: "Landfrauen", beschreibung: "Kaffee, Kuchen & mehr", verein: "Landfrauen Pfaffenweiler", x: 350, y: 250, width: 70, height: 180, farbe: "#be185d" },

  // Unten links – JUDO (12m hoch × 6m breit)
  { id: "judo", name: "Judo", beschreibung: "Wurstsalat, Käsespätzle & mehr", verein: "Judo Pfaffenweiler", x: 20, y: 390, width: 60, height: 120, farbe: "#7c3aed" },
